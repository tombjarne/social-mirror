                        ...
                        <div className="large-form-wrapper">
                            ...
                            <div className="large-input-group">
                                <FormControl
                                    ...
                                    id="search-input"
                                />
                                <Button type="submit" onClick={() => window.location.href="./influencer/analyse"}>Suchen</Button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="wrapper">
                        ...
                        <div className="icon-container">
                            <div className="icon-wrapper">
                                ...
                                <p>Influencer ist prinzipiell ein Beruf wie jeder andere. Influencer werden häufig von Agenturen oder Firmen beauftragt
                                ihre Produkte oder Marke zu repräsentieren. Für diese Leistungen erhalten die Influencer Geld. Im Gegenzug erhält die Firma mehr Reichweite.</p>
                            </div>
                            <div className="icon-wrapper">
                                <div>
                                ...
                                <p>Vielleicht hast du schon einmal beobachtet, dass Influencer für Produkte werben oder sogar ihre eigenen Artikel verkaufen. Doch häufig wird
                            ...
                            <div className="icon-wrapper">
                                ...
                                <p>Influencer sind nicht den ganzen Tag gücklich. Produkte verkaufen sich jedoch nur gut, wenn ein optimales, perfektes Leben vorgetäuscht oder
                    ...
                    <div className="wrapper">
                        ...
                        <div className="icon-container-alternativ">
                            ...
                            <p>
                                ...
                                und Followern dann erfolgreich verkauft werden sollen. Ein Influencer ist sozusagen der Marktschreier des 21 Jahrhunderts mit den Zielen
                            </p>
                            <ul className="slim-list">
                        ...
                        <div className="icon-container-alternativ">
                            ...
                            <Button href="#video-player" className="helper-btn cta-a">Zum Video</Button>
                            <p>
